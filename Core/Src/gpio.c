...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, FPGA_CS_Pin|TRIGGER_Pin|HEART_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : FPGA_CS_Pin TRIGGER_Pin */
  GPIO_InitStruct.Pin = FPGA_CS_Pin|TRIGGER_Pin;
