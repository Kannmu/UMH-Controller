...
# define DMA_FULL_BUFFER_SIZE (2 * DMA_Buffer_Resolution)
...
__ALIGNED(32) extern uint16_t DMA_Buffer[DMA_CHANNELS][DMA_FULL_BUFFER_SIZE] __attribute__((section(".dma")));
